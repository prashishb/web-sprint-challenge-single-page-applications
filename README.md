...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   ...
   This hook is used to add nested routes to an application so you can change a single parameter in the URL without changing the whole thing.

1. How would you explain form validation to someone who has never programmed before?

   Form validation is a set of rules specified for each field when creating a form. It checks whether the information you input meets the requirements in order to validate.

1. In 1-2 sentences, define end to end testing.

   End to end testing is used to test if a user can accomplish an action. It focuses on UI and mimics how a user might interact with an application.
